...
namespace GradeBook.UserInterfaces
{
    public static class StartingUserInterface
    {
        ...
        public static void CreateCommand(string command)
        {
            ...
            if (type.Equals("standard", StringComparison.InvariantCultureIgnoreCase))
            {
                gradeBook = new StandardGradeBook(name, isWeighted);
            }
            else if (type.Equals("ranked", StringComparison.InvariantCultureIgnoreCase))
            {
            ...
            Console.WriteLine("Created gradebook {0} of type {1} (Weighted: {2}).", name, type, isWeighted);
